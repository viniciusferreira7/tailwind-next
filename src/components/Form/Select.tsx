        ...
        >
          <SelectPrimitive.Viewport>
            <SelectPrimitive.Item
              value="br"
              className="py2.5 flex items-center justify-between gap-2 px-3 py-2.5 outline-none data-[highlighted]:bg-zinc-50"
            >
            ...
            <SelectPrimitive.Item
              value="eua"
              className="py2.5 flex items-center gap-2 px-3 py-2.5 outline-none data-[highlighted]:bg-zinc-50"
            >
              <SelectPrimitive.ItemText className="text-black">
                United States
              </SelectPrimitive.ItemText>
